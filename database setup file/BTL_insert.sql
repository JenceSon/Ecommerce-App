...
--insert Order
INSERT INTO [Order] VALUES ('ORDID000000031', 'Done', 1,  CONVERT(datetime, '14-11-2023', 105), 'PAYID1013', 'DELID0011');
INSERT INTO [Order] VALUES ('ORDID000000032', 'Done', 1, CONVERT(datetime, '14-11-2023', 105), 'PAYID1074', 'DELID0011');
INSERT INTO [Order] VALUES ('ORDID000000033', 'Confirming', 1, CONVERT(datetime, '14-11-2023', 105), 'PAYID1074', 'DELID0011');

INSERT INTO [Order] (order_id, status, no_productname, ID_payment, delivery_id)
VALUES
('ORDID000000001', 'Confirming', 3, 'PAYID0001', 'DELID0001'),
('ORDID000000002', 'Waiting pickup', 2, 'PAYID0002', 'DELID0002'),
('ORDID000000003', 'Delivering', 1, 'PAYID0003', 'DELID0003'),
('ORDID000000004', 'Done', 4, 'PAYID0004', 'DELID0004'),
('ORDID000000005', 'Cancelled', 2, 'PAYID0005', 'DELID0005');

--insert Is_contained
INSERT INTO Is_contained VALUES ('450080466', 'ORDID000000031');
INSERT INTO Is_contained VALUES ('450080467', 'ORDID000000032');
INSERT INTO Is_contained VALUES ('450080468', 'ORDID000000033');

INSERT INTO Is_contained (product_id, order_id)
VALUES
('PID000001', 'ORDID000000001'),
('PID000002', 'ORDID000000001'),
('PID000003', 'ORDID000000002'),
('PID000004', 'ORDID000000002'),
('PID000005', 'ORDID000000003');
